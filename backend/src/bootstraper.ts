...
import { type IRouter } from "./decorators/routes.decorator.js";
import { type IController } from "./decorators/controller.decorator.js";
...
class ExpressApplication {
  ...
  constructor(private config: IExpressApplication) {
    ...
    this.app.all("/api/v1/auth/*", toNodeHandler(auth));
